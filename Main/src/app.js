...
(0, typeorm_1.createConnection)().then(function (db) {
    ...
    amqp.connect("amqps://uxfpicer:wrkXarLhwelMJxm-FJ6mxnvQH7ZvGS6d@cougar.rmq.cloudamqp.com/uxfpicer", function (err0, connection) {
        if (err0) {
            throw err0;
        }
        connection.createChannel(function (err1, channel) {
            ...
            app.post('/products/:id/like', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                var product;
                return __generator(this, function (_a) {
                    switch (_a.label) {
